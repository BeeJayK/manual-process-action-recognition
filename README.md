## Overview
This repository contains all the code developed and related to the paper "Proving the Potential of Skeleton Based Action Recognition to Automate the Analyses of Manual Processes"
...
The work topic to be solved is the classification of motion classes, performed by a worker, during the packaging process in a production line, based on a video stream.
